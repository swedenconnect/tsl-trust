 ...
 */
package se.tillvaxtverket.tsltrust.admin.maint.ca;
...
public class CertificationAuthority implements CaKeyStoreConstants {
    ...
    public CertificationAuthority(String cAName, String caDir, TslTrustModel model) {
        ...
        this.caDir = caDir;
        this.ttConfig = (TslTrustConfig) model.getConf();
        ...
        exportCrlFile = new File(FileOps.getfileNameString(ttConfig.getCaFileStorageLocation() , "crl"), caID + ".crl");
        crlDpUrl = FileOps.getfileNameString(ttConfig.getCaDistributionURL() , "crl/" + caID + ".crl");
    }
