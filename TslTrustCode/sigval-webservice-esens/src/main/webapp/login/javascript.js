...
var loginURL = "https://tsltrust.esp-ttadmin.se/Shibboleth.sso/Login";
//var targetURL = "https://eid2.3xasecurity.com/sig/";
var targetURL = "https://tsltrust.esp-ttadmin.se/admin/";
...
function login(idpEntityId){
    window.location = loginURL + "?entityID="
    + encodeURIComponent(idpEntityId) + "&target="+encodeURIComponent(targetURL);
}
