    ...
    <body>
        ...
        <div style="float:right;width: 40%">
            <table>
                ...
                <TR>
                    <td>-</td><TD><a href="https://ttadmin.konki.se/tsltrustguest/">Validation policy details</a></TD>
                </TR>
                <tr><td>-</td><td>TSL Trust validation policy administration service <a href="https://ttadmin.konki.se/login/">login</td></tr>
                <TR>
